...
<head>
    ...
    <title>404 &middot; Không tìm thấy</title>
...
<main class="error-card">
    ...
    <h1 class="error-card__title">Không tìm thấy trang</h1>
    <p class="error-card__desc">Đường dẫn không tồn tại hoặc đã bị xóa.</p>
