...
<head>
    ...
    <title>Danh sách Vai trò - HRM System</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-action:hover {
            ...
            box-shadow: 0 2px 4px rgba(126, 34, 206, 0.15);
        }
    </style>
</head>
<body>
    ...
    <c:choose>
        <c:when test="${currentRoleId == 3}">
            <div class="nav-section">
                ...
                <a class="nav-item active" href="${pageContext.request.contextPath}/role-list"><span class="nav-icon">🏷</span> Vai trò</a>
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="welcome">
            ...
            <p>Danh sách các nhóm quyền hạn được cấu hình sẵn cho các nhân sự trong doanh nghiệp.</p>
        </div>

        <div class="table-card">
            <div class="table-header">
                <div class="table-title">Tất cả vai trò</div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="role-badge 
                                        <c:choose>
                                            <c:when test="${role.roleId == 3}">badge-advanced</c:when>
                                            <c:when test="${role.roleId == 2}">badge-admin</c:when>
                                            <c:otherwise>badge-common</c:otherwise>
                                        </c:choose>" style="font-size: .8rem; padding: 4px 12px;">
                                        ${role.roleName}
                                    </span>
                                </td>
                                <td>
